...
d3.json("./data/bipartite.json", function (error, loadeddata) {
...
function myfunction(i){
    var width = 550, height = 610, margin ={b:0, t:60, l:170, r:50};
    var  svg = d3.select("#bipartiteGraph")
        .attr('width',width).attr('height',(height+margin.b+margin.t))
        .append("g").attr("transform","translate("+ margin.l+","+margin.t+")");
    var svgdata = [
        {data:bP.partData(keyPair_final.splice(0,50),2), id:'Analysis', header:["Categories","State", "Top 1-50 businesses "]}];

    bP.draw(svgdata, svg);
var  svg1 = d3.select("#bipartiteGraph1")
    .attr('width',width).attr('height',(height+margin.b+margin.t))
    .append("g").attr("transform","translate("+ margin.l+","+margin.t+")");
var svgdata1 = [
    {data:bP.partData(keyPair_final.splice(0,50),2), id:'Analysis2', header:["Categories","State", "Top 50-100 businesses "]}];

bP.draw(svgdata1, svg1);
}

!function(){
	var bP={};	
	var b=30, bb=150, height=600, buffMargin=5, minHeight=14;
	var c1=[-165, 40], c2=[-50, 100], c3=[-10, 140]; //Column positions of labels.
	//var colors =["#3366CC", "#DC3912",  "#FF9900","#109618", "#990099", "#0099C6"];
	//var colors =  ["#666666", "#000000","#FFFF00","#CC0033","#3333FF","#FF00CC","#58011c","#adbce1","#6600a8","#db0e7f","#dfdfe5","#db6767","#666666", "#000000","#FFFF00","#CC0033","#3333FF","#FF00CC","#58011c","#adbce1","#6600a8","#db0e7f","#dfdfe5","#db6767","#666666", "#000000","#FFFF00","#CC0033","#3333FF","#FF00CC","#58011c","#adbce1","#6600a8","#db0e7f","#dfdfe5","#db6767","#666666", "#000000","#FFFF00","#CC0033","#3333FF","#FF00CC","#58011c","#adbce1","#6600a8","#db0e7f","#dfdfe5","#db6767","#666666", "#000000","#FFFF00","#CC0033","#3333FF","#FF00CC","#58011c","#adbce1","#6600a8","#db0e7f","#dfdfe5","#db6767"]
	//var colors = ["#40004b","#762a83","#9970ab","#c2a5cf","#e7d4e8","#f7f7f7","#d9f0d3","#a6dba0","#5aae61","#1b7837","#00441b","#40004b","#762a83","#9970ab","#c2a5cf","#e7d4e8","#f7f7f7","#d9f0d3","#a6dba0","#5aae61","#1b7837","#00441b"];
	var colors = ["#40004b","#762a83","#9970ab","#c2a5cf","#e7d4e8","#d9f0d3","#a6dba0","#5aae61","#1b7837","#00441b","#40004b","#762a83","#9970ab","#c2a5cf","#e7d4e8","#d9f0d3","#a6dba0","#5aae61","#1b7837","#00441b"];
